  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50/50 flex items-center justify-center">
      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10 text-center">
       ...
       {/*  ce composant rend son contenu uniquement si l'utilisateur est authentifiee. il enveloppe le btn get.. qui renvoi l'user ver /dashboard */}
        <SignedIn> 
          <Link href="/dashboard">
       ...
       {/* Ce composant affiche son contenu uniquement si le user n'est pas authentifiee. 
       il enveloppe le comp SignInButton qui affiche le btn sign up pour les user non connectee */}
        <SignedOut>

         {/*  ce composant affiche un btn qui lorsqu'il est cliquee ouvre l'interface de connexion. ici 
          il est configuree pour s'ouvrir en tant que modal et redirige vers /dahboard si la connexion est reussi */}
          <SignInButton
            mode="modal"
